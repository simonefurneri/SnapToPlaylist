...
export function SongList({
  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-5 px-1 sm:px-0">
      ...
      <div className="bg-neutral-900/90 border border-neutral-800 rounded-3xl p-5 sm:p-7 backdrop-blur shadow-2xl relative overflow-hidden transition-all duration-300">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 relative z-10">
              ...
              {isEditingTitle ? (
                <div className="flex items-center gap-2 w-full">
                  ...
                  <button
                    ...
                    className="p-2 rounded-xl bg-[#1DB954] hover:bg-[#1ed760] text-black font-bold transition-all duration-200 cursor-pointer flex-shrink-0"
                    title="Conferma nome"
                  >
                ...
                <div className="flex items-center gap-2.5 group/title w-full">
                  ...
                  <button
                    type="button"
                    onClick={() => setIsEditingTitle(true)}
                    className="p-1.5 rounded-lg text-neutral-400 hover:text-[#1DB954] hover:bg-neutral-800/80 transition-all duration-200 cursor-pointer flex-shrink-0"
          ...
          <div className="flex items-center gap-2 flex-shrink-0 self-start">
            <button
              ...
              className="text-xs font-semibold text-neutral-300 hover:text-white px-3.5 py-2 rounded-xl bg-neutral-800/80 hover:bg-neutral-800 border border-neutral-700/50 transition-all duration-200 cursor-pointer disabled:opacity-50 flex items-center gap-1.5 active:scale-95"
            >
        ...
        {isFullyChecked && (
          <div className="mt-4 pt-4 border-t border-neutral-800/80 flex flex-wrap items-center justify-between gap-2 text-xs">
        ...
        {hasUncheckedChanges && songs.length > 0 && (
          <div className="mt-4 pt-4 border-t border-neutral-800/80 flex items-center gap-2 text-xs text-amber-400">
      ...
      {/* 2. Song List Table */}
      <div className="bg-neutral-900/70 border border-neutral-800 rounded-3xl overflow-hidden shadow-xl backdrop-blur">
        {/* Table Header */}
        <div className="px-4 sm:px-6 py-3.5 border-b border-neutral-800 flex items-center justify-between bg-neutral-950/50">
          ...
          <button
            ...
            onClick={onAddSong}
            disabled={isVerifying || isCreating}
            className="text-xs font-semibold text-neutral-300 hover:text-[#1DB954] flex items-center gap-1.5 py-1.5 px-3 rounded-xl bg-neutral-800/80 hover:bg-neutral-800 transition-all duration-200 cursor-pointer disabled:opacity-50 active:scale-95"
          >
          ...
          {songs.map((song, index) => {
            ...
            return (
              <div
                ...
                className={`p-3.5 sm:px-6 flex items-center justify-between gap-3 transition-all duration-200 group ${
                  isCurrentlyChecking
                ...
                <div className="flex items-center gap-2.5 sm:gap-3 flex-shrink-0">
                  ...
                  <div className="relative flex items-center justify-center w-7 h-7 sm:w-8 sm:h-8">
                    {song.status === "searching" || isCurrentlyChecking ? (
                      ...
                      >
                        <CheckCircle2 className="w-6 h-6 text-[#1DB954] drop-shadow-[0_0_8px_rgba(29,185,84,0.4)] transition-transform duration-200 group-hover/tip:scale-110" />
                      </div>
                    ) : song.status === "not_found" ? (
                      <div
                        className="group/tip relative flex items-center justify-center cursor-pointer"
                      ...
                      >
                        <XCircle className="w-6 h-6 text-rose-500 drop-shadow-[0_0_8px_rgba(244,63,94,0.4)] transition-transform duration-200 group-hover/tip:scale-110" />
                      </div>
                    ) : (
                  ...
                  {/* Album Cover Thumbnail (always visible on mobile & desktop) */}
                ...
                <div className="flex items-center gap-1 sm:gap-1.5 flex-shrink-0">
                  {isEditing ? (
                    ...
                    <button
                      ...
                      disabled={isVerifying || isCreating}
                      className="p-1.5 text-neutral-400 hover:text-white rounded-lg hover:bg-neutral-800 transition-all duration-200 cursor-pointer disabled:opacity-30"
                  ...
                  <button
                    ...
                    disabled={isVerifying || isCreating}
                    className="p-1.5 text-neutral-500 hover:text-rose-400 rounded-lg hover:bg-rose-950/40 transition-all duration-200 cursor-pointer disabled:opacity-30"
                    title="Rimuovi brano"
                  >
        ...
        <div className="p-4 sm:p-6 bg-neutral-950/90 border-t border-neutral-800 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 sm:gap-4">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5">
            ...
            <button
              ...
              className={`py-3 px-5 rounded-2xl font-bold text-xs sm:text-sm transition-all duration-200 flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed active:scale-95 ${
                !hasUncheckedChanges
            ...
            <button
              ...
              className="py-3 px-6 rounded-2xl bg-gradient-to-r from-[#1DB954] via-emerald-500 to-teal-500 hover:from-[#1ed760] hover:to-teal-400 text-neutral-950 font-extrabold text-xs sm:text-sm transition-all duration-200 shadow-xl shadow-[#1DB954]/25 flex items-center justify-center gap-2 cursor-pointer disabled:opacity-35 disabled:cursor-not-allowed active:scale-95 hover:scale-[1.02]"
              title={
                hasUncheckedChanges
